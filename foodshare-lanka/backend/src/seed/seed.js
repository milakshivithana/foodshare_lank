...
const users=await User.insertMany([
 ...
 {name:'FoodShare Admin',organizationName:'FoodShare Lanka',email:adminEmail,phone:'0700000000',password:adminPass,role:'ADMIN',address:'Colombo',city:'Colombo',district:'Colombo'}
]);
...
await Donation.insertMany(donations);console.log(`Seed complete. Admin login: ${adminEmail}`);process.exit(0);
